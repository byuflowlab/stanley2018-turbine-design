...
mkdir XYZ
	...
	do
      ...
      spacing=$(echo print $j/10. | python)
			...
			echo $(echo $(awk 'NR==3 {print $3}' $shear/$spacing/XYZ_$file.txt)) >> results_${shear}.txt
			...
			echo $(echo $(awk 'NR==3 {print $1,$2,$3}' $shear/$spacing/diameter_$file.txt)) >> results_${shear}.txt
			...
			echo $(echo $(awk 'NR==3 {print $1,$2,$3}' $shear/$spacing/thickness_$file.txt)) >> results_${shear}.txt
