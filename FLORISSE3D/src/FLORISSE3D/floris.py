...
class Floris(Component):
    ...
    def solve_nonlinear(self, params, unknowns, resids):
        ...
        # print 'FLORIS: '
        # print 'WindSpeeds: ', Vinf
        # print 'TurbineSpeeds: ', wtVelocity
    ...
    def linearize(self, params, unknowns, resids):
        ...
        # print '@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@'
        # print 'X: ', turbineXwb
        # print 'turbineX: ', turbineXw
        # print 'Y: ', turbineYwb
        # print 'turbineY: ', turbineYw
        # print 'Z: ', turbineZb
...
class AEPGroup(Group):
    ...
    def __init__(self, nTurbines, nDirections, use_rotor_components=False, datasize=0,
        ...
        self.add('getUeff', PowWind(nDirections, nTurbines), promotes=['*'])
