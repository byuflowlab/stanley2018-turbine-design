...
class OtherMainframeCost2015(Component):
    ...
    def execute(self):
        print 'platform mass: ', self.nacelle_platforms_mass
...
def example():
    ...
    turbine.blade_mass = 12379.97  # inline with the windpact estimates
    turbine.hub_mass = 29793.94
    turbine.pitch_system_mass = 7594.63
    turbine.spinner_mass = 979.20
