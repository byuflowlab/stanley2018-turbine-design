...
def myCosts():
    ...
    turbine.blade_mass = 4230.  # inline with the windpact estimates
    turbine.hub_mass = 15104.
    turbine.pitch_system_mass = 4949
    turbine.spinner_mass = 526.95
    turbine.low_speed_shaft_mass = 9097.58
    #bearingsMass = 9731.41
    turbine.main_bearing_mass = 2832.37 / 2
    turbine.second_bearing_mass = 2832.37 / 2 #KLD - revisit this in new model
    turbine.gearbox_mass = 8800.79
    turbine.high_speed_side_mass = 434.25
    turbine.generator_mass = 5009.955
    turbine.bedplate_mass = 27094.
    turbine.yaw_system_mass = 3457.22
